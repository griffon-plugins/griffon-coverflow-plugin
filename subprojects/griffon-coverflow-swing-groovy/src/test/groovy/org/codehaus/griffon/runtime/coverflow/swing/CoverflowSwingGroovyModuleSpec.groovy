 ...
 */
class CoverflowSwingGroovyModuleSpec extends Specification {
    static {
    ...
    def 'Builder customizer is configured correctly'() {
        ...
        where:
        node            | factory
        'gradientPanel' | ComponentFactory
        'stackLayout'   | LayoutFactory
        'imageFlow'     | ImageFlowFactory
        'imageFlowItem' | ImageFlowItemFactory
    }
