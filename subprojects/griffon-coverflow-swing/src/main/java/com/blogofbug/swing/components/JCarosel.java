...
public class JCarosel extends GradientPanel implements MouseListener,
     ...
     *
     * @param contentWidth The prefered width of component at neutral scale (3 or 9
     *                     o'clock)
     */
     ...
     *
     * @param useDepthBased True to fade components as they move to the back, false to not
     *                      do it
     */
